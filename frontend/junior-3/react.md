...
* Pure Components
  ...
  * Какие ограничения ложатся на пропсы при использовании пьюр компонент?
    * Почему использование пьюр компоненты таким образом не приносит никакой пользы (укажите на конкретные проблемные места):
      ```javascript
