...
* Context
  ...
  * Как повлияет на компоненты, которые подписаны на контекст, если Pure Component будет находиться между подписчиком и провайдером контекста?
* Higher-Order Components
  ...
  * Какие проблемы будут возникать, если HOC не будет прокидывать входящие props дальше в потомка?
  * Как обрабатывать `displayName` при создании HOC?
  * Какие проблемы будут возникать, если каждый раз билдить HOC в самом render?
  * Какие проблемы будут возникать, если HOC не будет переопределять все статичные методы потомка?
