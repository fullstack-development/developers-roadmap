...
* Как работает `calc()`? Подробно рассказать какие параметры принимает, какие операции допустимы, в каких единицах измерения можно задавать значения параметров.
