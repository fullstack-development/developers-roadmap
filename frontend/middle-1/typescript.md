...
* Что такое вывод типов (относительно любого языка)? В каких случаях TS может выводить типы для генериков? В каких случаях TS автоматически выводить переменную типа как any?
