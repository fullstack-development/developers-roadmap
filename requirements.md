...
* Объединять вопросы по смыслу
  * Вопросы можно вкладывать в объединяющие вопросы или названия тем. Например, вопросы, относящиеся к веткам в гите:
    ```
    * Ветки
      * Что такое ветка?
      * Зачем нужны ветки?
    ...
    * Как задать количество и размеры строк (колонок)?
      ...
      * Как задать несколько строк (колонок) одинакового размера?
      ...
    ```
  * Также допустимо писать вопросы по одной теме на одной строке, если вопросов не сильно много и они не сильно длинные. Впросы в таком случае следует писать в отдельных предложениях, а не в одном:
    ```
    // плохо
